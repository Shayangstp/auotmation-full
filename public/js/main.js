...
window.onload = function () {
    ...
    function storePushSub() {
        ...
        navigator.serviceWorker.ready
            ...
            .then(function (pushSubscription) {
                ...
                const vapidPublicKey = 'BLAiazjQIVW4l3DR-cMfY4-affoUhnukETKid2b3xzVVwqj1yIgQeLyFaqOOxC53zGmzQWwhVHl8YUxq0hZqy80';
                const convertedVapidKey = urlBase64ToUint8Array(vapidPublicKey);
                return swreq.pushManager.subscribe({
    ...
    if ('Notification' in window && 'serviceWorker' in navigator && notificationButton !== undefined) {
    ...
    window.addEventListener('resize', function(event) {
        ...
        }else if(window.innerWidth >= 1200 && sideBar.classList.contains('w-5')){
