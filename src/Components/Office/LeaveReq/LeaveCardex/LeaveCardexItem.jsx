...
const LeaveCardexItem = ({ columns, data, onSort, fetchData, loading, pageCount: controlledPageCount, tableData }) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
    ...
    useEffect(() => {
        fetchData({ pageIndex, pageSize, tableData });
        onSort({ sortBy, pageIndex, pageSize, tableData });
    }, [onSort, sortBy, fetchData, pageIndex, pageSize, tableData]);
    return (
        <section>
            <Table bordered hover responsive striped size="sm" {...getTableProps()}>
                <thead>
                ...
                <tbody {...getTableBodyProps()}>
                    ...
                    <tr>
                        {loading ? (
                            ...
                            <td colSpan="10000">
                                نمایش {page.length} از ~{tableData.length}{" "}
                                نتیجه
                            </td>
                        )}
                    </tr>
...
export default LeaveCardexItem;