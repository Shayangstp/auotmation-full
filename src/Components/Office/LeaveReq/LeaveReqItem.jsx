...
const LeaveReqItem = ({ columns, data, onSort, fetchData, loading, pageCount: controlledPageCount, requests, notVisited, handleNotVisited }) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
