...
import { faAngleDoubleRight, faAngleRight, faAngleLeft, faAngleDoubleLeft } from "@fortawesome/free-solid-svg-icons";

const OverTimeReqItem = ({ requests, columns, data, onSort, fetchData, loading, pageCount: controlledPageCount, notVisited, handleNotVisited}) => {
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
      ...
      <Table bordered hover responsive size="sm" {...getTableProps()}>
        ...
        <tbody {...getTableBodyProps()}>
          {page.map((row, i) => {
            ...
            return (
              <tr {...row.getRowProps()} className={findNoVisited() !== undefined ? 'fw-bold' : ''} key={i}>
...
export default OverTimeReqItem;
