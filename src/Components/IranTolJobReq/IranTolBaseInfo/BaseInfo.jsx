...
import {
  ...
  selectIrantoolUsersByRoleList,
  handleOperationUnitList,
  selectIrantoolOperationUnitList,
  selectIrantoolOperatorList,
  handleOperatorList,
  handleOperationList,
  selectIrantoolOperationList,
  handleReasonOfDelayList,
  selectIrantoolReasonOfDelayList,
...
const BaseInfo = () => {
  ...
  const irantoolOperationUnitList = useSelector(
    selectIrantoolOperationUnitList
  );
  ...
  const irantoolReasonOfDelayList = useSelector(
    selectIrantoolReasonOfDelayList
  );
      ...
      <Tabs defaultActiveKey={1}>
        <Tab eventKey={1} title="واحدهای عملیاتی" className="pt-5">
          <div className="d-flex align-items-center mb-5">
            <FontAwesomeIcon
              icon={faPlusSquare}
              className="btn-success font24 py-1 px-2 rounded me-2"
              onClick={() => {
            ...
            <FontAwesomeIcon
              icon={faMinusSquare}
              className="btn-danger font24 py-1 px-2 rounded me-2 ms-4"
              onClick={() => {
                dispatch(RsetAddRole(false));
              }}
            />
            حذف
            {addRole === true || addRole === false ? (
              <Fragment>
                <FontAwesomeIcon
                  icon={faCancel}
                  className="btn-secondary font24 py-1 px-2 rounded me-2 ms-4"
                  onClick={() => {
          ...
          <BaseInfoTable
            handleList={handleOperationUnitList}
            list={irantoolOperationUnitList}
            role="operatingUnit"
          />
        </Tab>
        <Tab eventKey={2} title="تایید کننده QC" className="pt-5">
          ...
          <BaseInfoTable
            handleList={handleIrtUsersByRole}
            list={irantoolUsersByRoleList}
            role="changeUserRole"
          />
        </Tab>
        <Tab eventKey={3} title="اپراتور ها" className="pt-5">
          ...
          <BaseInfoTable
            handleList={handleOperatorList}
            list={irantoolOperatorList}
            role="OperatorRole"
          />
        </Tab>
        <Tab eventKey={4} title="عملیات" className="pt-5">
          ...
          <BaseInfoTable
            handleList={handleOperationList}
            list={irantoolOperationList}
            role="OperationRole"
          />
        </Tab>
        <Tab eventKey={5} title="علت تاخیر" className="pt-5">
          ...
          <BaseInfoTable
            handleList={handleReasonOfDelayList}
            list={irantoolReasonOfDelayList}
            role="ReasonOfDelayRole"
          />
        </Tab>
