  ...
  const submitFormBtn = (e) => {
    ...
    if (irantoolAddOperatingUnitName !== "") {
      const changedValues = {
        ...
        operatingDepId: addRole
          ? undefined
          : irantoolAddOperatingUnitName.value,
        ...
        <Row className="align-items-center mb-5">
          <Form.Group as={Col} md="4" lg="4" xxl="3" className="mb-4 mb-md-0">
            ...
            {addRole ? (
              <Form.Control
                type="text"
                name="irantoolAddOperatingUnitName"
                value={irantoolAddOperatingUnitName}
                onChange={(e) =>
                  dispatch(RsetIrantoolAddOperatingUnitName(e.target.value))
                }
              />
            ) : (
              <Select
                name="irantoolAddOperatingUnitName"
                value={irantoolAddOperatingUnitName}
                onChange={(e) => dispatch(RsetIrantoolAddOperatingUnitName(e))}
                options={irantoolOperationUnitList}
              />
            )}
          ...
          <Col className="d-flex mt-md-3 mt-0 ">
