...
const IranTolJobReqItem = ({ columns, data, onSort, fetchData, loading, pageCount: controlledPageCount, requests, notVisited, handleNotVisited }) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
...
export default IranTolJobReqItem;
