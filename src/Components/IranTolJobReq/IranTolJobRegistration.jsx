...
const IranTolJobRegistration = ({ setPageTitle }) => {
  ...
  return (
    <div>
      <Container
        className="lightGray2-bg p-3 shadow mt-5 borderRadius borderWhite"
        data-bs-theme="dark"
      >
        {/* {menuPermission ? */}
        ...
        <Form className="position-relative">
          ...
          <Row>
            <Form.Group as={Col} md="12" className="mb-4">
              ...
              <Form.Control
                name="iTJProjectName"
                value={iTJProjectName}
                onChange={(e) => setITJProjectName(e.target.value)}
                ref={iTJProjectNameRef}
              />
              <div id="iTJProjectName-required" className="d-none mt-1">
                <span className="font12 text-danger mb-1">
                  واردکردن نام پروژه اجباری است!
                </span>
              </div>
            </Form.Group>
            <Form.Group as={Col} md="6" lg="3" className="mb-4">
              ...
              <Select
                value={iTJProjectType}
                name="iTJProjectType"
                onChange={(e) => {
                  setITJProjectType(e);
                }}
                placeholder="انتخاب..."
                options={iTJProjectTypeSelect}
                ref={iTJProjectTypeRef}
              />
              <div id="iTJProjectType-required" className="d-none mt-1">
                <span className="font12 text-danger mb-1">
                  انتخاب نوع فرایند اجباری است!
                </span>
              </div>
            </Form.Group>
            <Form.Group as={Col} md="6" lg="3" className="mb-4">
              ...
              <Select
                value={iTJProjectTool}
                name="iTJProjectTool"
                onChange={(e) => {
                  setITJProjectTool(e);
                }}
                placeholder="انتخاب..."
                options={iTJProjectToolSelect}
                ref={iTJProjectToolRef}
              />
              <div id="iTJProjectTool-required" className="d-none mt-1">
                <span className="font12 text-danger mb-1">
                  انتخاب نوع پروژه اجباری است!
                </span>
              </div>
            </Form.Group>
            <Form.Group as={Col} md="6" lg="3" className="mb-4">
              ...
              <NumberFormat
                type="text"
                value={iTJProjectAmount}
                thousandSeparator=","
                name="iTJProjectAmount"
                id="reqItemAmount"
                onChange={(e) => {
                  setITJProjectAmount(e.target.value);
                }}
                dir="ltr"
            ...
            <Form.Group as={Col} md="12">
              ...
              <Form.Control
                ...
                maxLength={2000}
                name="iTJProjectDesc"
                value={iTJProjectDesc}
                onChange={(e) => setITJProjectDesc(e.target.value)}
              />
            </Form.Group>
          </Row>
          <Row>
            <Col
              md="5"
              xl="4"
              className="mx-auto d-flex justify-content-between flex-wrap mt-4"
            >
              <Button
                variant="success"
                id="confirmITJReq"
                onClick={(e) => handleConfirmITJReq()}
              >
                ثبت درخواست
              </Button>
              <Button
                ...
                onClick={(e) => setActionToPersonsModal(true)}
              >
                ارسال
              </Button>
              <Button
