...
const IranTolJobReqsFilter = () => {
    ...
    return (
        <Row className='align-items-center mb-5'>
            ...
            <Form.Group as={Col} md='4' lg='3' xl='3' className='mb-4 mb-lg-0 mb-xl-4'
                onKeyUp={(option) => {
                    option.which = option.which || option.keyCode;
                    if (option.which === 13) {
                        const valueLength = serialFilter.replace(/-/g, '').length;
            ...
            <Form.Group as={Col} md='4' lg='3' xl='2' className='mb-4 mb-lg-0 mb-xl-0'>
            ...
            <Form.Group as={Col} md='4' lg='3' xl='2' className='mb-4 mb-md-0  mb-lg-0 mb-xl-0'>
