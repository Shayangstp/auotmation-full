        ...
        <div className="d-flex flex-column  mb-5 lightGray2-bg p-3 borderRadius m-auto shadow border border-white border-2">
            ...
            >
                ...
                >
                    ...
                    <Select id='companyFilterSelect' placeholder='همه' isSearchable value={companyFilterSelect} options={usersFilterSelect}
                        onChange={(option) => {
                ...
                >
                    <Form.Label id='firstname' className='mb-1'>نوع فرآیند:</Form.Label>
                    <Select id='projectTypeFilterSelect' placeholder='همه' isSearchable value={projectTypeFilterSelect} options={iTJProjectTypeWithAllSelect}
                        onChange={(option) => {
                ...
                >
                    <Form.Label id='firstname' className='mb-1'>نوع پروژه:</Form.Label>
                    <Select id='toolTypeFilterSelect' placeholder='همه' isSearchable value={toolTypeFilterSelect} options={iTJProjectToolWithAllSelect}
                        onChange={(option) => {
                ...
                >
                    ...
                    <Select id='stauses' placeholder='همه' isSearchable value={statusIdFilterSelect} options={allStatuses}
                        onChange={(option) => {
                ...
                <Form.Group as={Col} md='4' lg='2' className='mb-4 mb-lg-0'>
                    <Form.Label id='fromDate' className='mb-1'>از تاریخ درخواست :</Form.Label>
                    <DatePicker inputReadOnly name='from_date' isGregorian={false} timePicker={false} inputFormat="YYYY-MM-DD" value={fromDateFilter} className="form-control"
                        onChange={value => {
                ...
                <Form.Group as={Col} md='4' lg='2' className='mb-4 mb-md-0 mb-lg-0'>
                    <Form.Label id='toDate' className='mb-1'>تا تاریخ درخواست :</Form.Label>
                    <DatePicker inputReadOnly name='from_date' isGregorian={false} timePicker={false} inputFormat="YYYY-MM-DD" value={toDateFilter} className="form-control"
                        onChange={value => {
                ...
                <Col md='4' lg='3' xl='3' className='mt-4 ms-auto'>
                    <div className="d-flex justify-content-end">
                        ...
                        <Button variant='secondary' className='font12 ms-1' onClick={() => handleCancelFilter('ITJReq')}>
                            لغو فیلتر
                        </Button>
                    </div>
                </Col>
