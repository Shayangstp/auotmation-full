...
const PurchaseReqItem = ({ columns, data, onSort, fetchData, loading, pageCount: controlledPageCount, requests }) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
    ...
    return (
        <section>
            <Table bordered hover striped responsive size="sm" {...getTableProps()}>
                <thead>
                ...
                <tbody {...getTableBodyProps()}>
                    ...
                    <tr>
                        {loading ? (
                            ...
                            <td colSpan="10000">
                                نمایش {page.length} از ~{requests.length}{" "}
                                نتیجه
                            </td>
                        )}
                    </tr>
...
export default PurchaseReqItem;
