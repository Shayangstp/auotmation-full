...
const Requests = ({ columns, data, onSort, fetchData, loading, pageCount: controlledPageCount, requests, notVisited, handleNotVisited }) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
                ...
                <tbody {...getTableBodyProps()}>
                    ...
                    <tr>
                        {loading ? (
                            ...
                            <td colSpan="10000">
                                نمایش {page.length} از ~{requests.length}{" "} نتیجه
                            </td>
                        )}
                    </tr>
                </tbody>
