...
import {
    handleGetSalesChart, selectYearChartTypeNames, selectMonthChartTypeNames, selectMonthChartTypeValues, selectYearChartTypeValues,
    selectProvinceChartTypeNames, selectProvinceChartTypeValues, selectSeasonChartTypeNames, selectSeasonChartTypeValues,
    selectCustomerChartTypeNames, selectCustomerChartTypeValues
...
const SaleCharts = () => {
    ...
    const options = {
        ...
        xaxis: {
            ...
            categories: ['مظروف یزد', 'ساچی', 'بلور تابان', 'فلوت دماوند', 'ایران فلوت', 'فلوت کاویان', 'کربنات', 'بلور کاوه', 'کاوه فلوت', 'کاوه سیلیس', 'متانول', 'ایران تول', 'آسا فلوت'],
            tickPlacement: 'on',
        },
        yaxis: {
            labels: {
    ...
    const options2 = {
        ...
        xaxis: {
            ...
            categories: ["ایران فلوت", "بلور تابان", "کاوه سودا", "کربنات", "مظروف یزد", "کاوه فلوت", "بلور ساچی"]
        },
        yaxis: {
            labels: {
                offsetX: -30,
    ...
    const provinceOptions = {
        ...
        colors: ['#7266ba', '#41a4f5', '#7ed320', '#f65c81', '#ffda07', '#f00d5b', '#50296f', '#fa8c2d', '#ED6A5E', '#D291BC'],
        dataLabels: {
            enabled: true
        },
        fill: {
    ...
    useEffect(() => {
        dispatch(handleGetSalesChart({ financeYear: '', chartType: 'Month', numberOfRows: 10 }));
        dispatch(handleGetSalesChart({ financeYear: '', chartType: 'Products', numberOfRows: 10 }));
        dispatch(handleGetSalesChart({ financeYear: '', chartType: 'FinanceYear', numberOfRows: 10 }));
        dispatch(handleGetSalesChart({ financeYear: '', chartType: 'Customers', numberOfRows: 10 }));
        dispatch(handleGetSalesChart({ financeYear: '1401', chartType: 'Season', numberOfRows: 10 }));
    }, [])
    ...
    return (
        <Container fluid>
            <Row className="py-5">
                <Col md='12'>
                    <div className="my-4 text-center fw-bold">فروش ماهانه بلور به تفکیک 5 سال اخیر</div>
                    <ReactApexChart options={options44} series={series44} type="area" height={350} />
                </Col>
            </Row>
            <hr className="my-5" />
            <Row className="py-5">
                <Col md='6'>
                    ...
                    <ReactApexChart options={yearOptions} series={yearSeries} type="pie" height={350} />
                </Col>
                <Col md='6'>
                    <div className="my-4 fw-bold">10 محصول پر فروش بلور</div>
                    <ReactApexChart options={provinceOptions} series={provinceSeries} type="donut" height={350} />
                </Col>
            </Row>
            <hr className="my-5" />
            <Row className="py-5">
            ...
            <Row className="py-5">
                <Col md='12'>
                    <div className="my-4 text-center fw-bold">فروش فصلی 5 سال اخیر بلور</div>
                    <ReactApexChart options={seasonOptions} series={seasonSeries} type="bar" height={350} />
                </Col>
            </Row>
            {/* <Row>
