        ...
        <div>
          <section className="min-vh-100 vw-100 vh-100 position-absolute left-0 right-0 top-0 inputDesign">
            <Container
              ...
              className={
                accountMode === "login"
                  ? "min-vh-100 d-grid align-items-center blueOpacity"
                  : "min-vh-100 d-grid align-items-center purpleOpacity"
              }
            >
              <Row>
                ...
                <Col
                  md="12"
                  lg="6"
                  className="mx-auto p-4 rounded  shadow lightOpacity text-white my-3"
                  style={{ zIndex: 100 }}
                >
                        ...
                        >
                          ...
                          >
                            <NumberFormat
                              ...
                              className={birthCertificateNumberValidationClass}
                              disabled={birthCertificateNumberDisabled}
                            />
                            <Form.Control.Feedback type="invalid">
                              <div
                          ...
                          >
                            <NumberFormat
                              ...
                              className={bankAccountNumberValidationClass}
                              disabled={bankAccountNumberDisabled}
                            />
                            <Form.Control.Feedback type="invalid">
                              <div
                                id="bankAccountNumber-required"
                                className="d-none"
                              >
                                <span className="font12 mb-1">
                                  واردکردن شماره حساب بانکی اجباری است!
                                </span>
                              </div>
                            </Form.Control.Feedback>
                          </Form.Group>
                          ...
                          <Form.Group
                            as={Col}
                            md="6"
                            className="mb-4 px-0 px-md-3 selectDesign"
                          >
                            <Select
                              value={position}
                              name="position"
                            ...
                            <div id="position-required" className="d-none mt-1">
                              <span className="font12 text-danger mb-1">
                                واردکردن سمت اجباری است!
                              </span>
                            </div>
                          </Form.Group>
                          <Form.Group
                          ...
                          >
                            <Select
                              ...
                              options={genders}
                              ref={genderRef}
                              isDisabled={genderDisabled}
                            />
                            <div id="gender-required" className="d-none mt-1">
                              <span className="font12 text-danger mb-1">
                                واردکردن جنسیت اجباری است!
                              </span>
                            </div>
                          </Form.Group>
                          <Form.Group
                          ...
                          >
                            ...
                            <Form.Control.Feedback type="invalid">
                              <div id="firstName-required" className="d-none">
                                <span className="font12 mb-1">
                                  واردکردن نام اجباری است!
                                </span>
                              </div>
                              <div id="firstName-validation" className="d-none">
                                <span className="font12">
                                  نام حداقل باید 3 کاراکتر باشد!
                                </span>
                              </div>
                            </Form.Control.Feedback>
                          </Form.Group>
                          ...
                          >
                            ...
                            <Form.Control.Feedback type="invalid">
                              <div id="lastName-required" className="d-none">
                                <span className="font12 mb-1">
                                  واردکردن نام خانوادگی اجباری است!
                                </span>
                              </div>
                              <div id="lastName-validation" className="d-none">
                                <span className="font12">
                                  نام خانوادگی حداقل باید 3 کاراکتر باشد!
                                </span>
                              </div>
                            </Form.Control.Feedback>
                          </Form.Group>
                          ...
                          >
                            ...
                            <Form.Control.Feedback type="invalid">
                              <div id="email-required" className="d-none">
                                <span className="font12 mb-1">
                                  واردکردن ایمیل اجباری است!
                                </span>
                              </div>
                              <div id="email-validation" className="d-none">
                                <span className="font12">
                                  فرمت ایمیل معتبر نمی باشد!
                                </span>
                              </div>
                            </Form.Control.Feedback>
                          </Form.Group>
                          ...
                          >
                            <NumberFormat
                              ...
                              className={localPhoneValidationClass}
                              disabled={localPhoneNumberDisabled}
                            />
                            <Form.Control.Feedback type="invalid">
                              <div id="localPhone-required" className="d-none">
                                <span className="font12 mb-1">
                                  واردکردن شماره داخلی اجباری است!
                                </span>
                              </div>
                              <div
                                id="localPhone-validation"
                                className="d-none"
                              >
                                <span className="font12">
                                  شماره داخلی حداقل باید 4 کاراکتر باشد!
                                </span>
                              </div>
                            </Form.Control.Feedback>
                          </Form.Group>
                          ...
                          >
                            <Select
                              ...
                              onChange={(e) => {
                                setCompany(e);
                                handleGetCoDepartments(e.value, location.value);
                                setDepartment("");
                                setSupervisor("");
                              }}
                              ref={companyRef}
                              placeholder="انتخاب شرکت بیمه ای"
                              options={companies}
                              isSearchable
                          ...
                          >
                            ...
                            >
                              <span className="font12 text-danger mb-1">
                                انتخاب واحد سازمانی اجباری است!
                              </span>
                            </div>
                          </Form.Group>
                          <Form.Group
                          ...
                          >
                            <Select
                              ...
                              options={supervisorsByCoDepSelect}
                              isSearchable
                              isDisabled={supervisorDisabled}
                            />
                          </Form.Group>
                          <Form.Group
                            as={Col}
                          ...
                          >
                            <Form.Check
                              type="checkbox"
                              label="صحت و مسئولیت اطلاعات درج شده از نظر اینجانب مورد تایید است."
                              name="verifyInfo"
                              value={verifyInfo}
                              checked={verifyInfo}
                              onChange={() => {
                              ...
                              disabled={verifyInfoDisabled}
                            />
                            <div
                              id="verifyInfo-required"
                              className="d-none mt-1"
                            >
                              <span className="font12 text-danger mb-1">
                                تایید صحت و مسئولیت اطلاعات اجباری است!
                              </span>
                            </div>
                          </Form.Group>
