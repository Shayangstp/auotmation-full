                ...
                <section className="min-vh-100 position-absolute top-0 backImage inputDesign">
                    <Container fluid className={accountMode === 'login' ? 'min-vh-100 d-grid align-items-center blueOpacity' : 'min-vh-100 d-grid align-items-center purpleOpacity'}>
                        <Row>
                                    ...
                                    <Fragment>
                                        {accountMode === 'login' ?
                                            <Form>
                                                ...
                                                <Form.Group className='mb-4'>
                                                    <div className="position-relative">
                                                        <Form.Control autocomplete="off" dir="ltr" id='passInput' placeholder="رمزعبور" type={passType} value={password} name="password" onChange={(e) => { dispatch(RsetPassword(e.target.value)) }} ref={passwordRef} />
                            ...
                            <Col md='12'>
                                <Row>
                                    <Col md='12' lg='6' className="d-flex justify-content-between mx-auto">
                                        <div className="text-white">
                                            {showChangePassCom === false ?
                                                <span className="font12 cursorPointer text-decoration-underline fw-bold text-warning" onClick={() => {
                                                    dispatch(RsetShowChangePassCom(true));
                                                }}>فراموشی رمز عبور</span>
                                                :
                                                <span className="font12 cursorPointer text-decoration-underline" onClick={() => {
