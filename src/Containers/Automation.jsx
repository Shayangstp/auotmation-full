  ...
  return (
    <MainContext>
      <MainLayout
        pageTitle={pageTitle}
        lockLinks={lockLinks}
        setLocklinks={setLocklinks}
        lockLinksModal={lockLinksModal}
        setLockLinksModal={setLockLinksModal}
      ...
      >
        <Switch>
          ...
          <Route
            ...
            render={() =>
              hasJWT() === false ||
              localStorage.getItem("id") !== "6360ecd33ba4d4828c9cb40b" ? (
                <Redirect to="/" />
              ) : (
                <MainContext>
          ...
          <Route
            ...
            render={() =>
              ...
              (user.Roles !== undefined &&
                user.Roles.some((role) => role === "22") === false) ? (
                <Redirect to="/" />
              ) : (
          ...
          />
          <Route
            path="/CeramicProductsPriceRegistration"
            render={() =>
              hasJWT() === false ? (
                <Redirect to="/" />
              ) : (
          ...
          />
          <Route
            path="/CeramicJobReqPriceRegistration"
            render={() =>
              hasJWT() === false ? (
                <Redirect to="/" />
              ) : (
          ...
          <Route
            ...
            render={() =>
              hasJWT() === false ||
              (user.Roles !== undefined &&
                user.Roles.some((role) => role === "24") === false) ? (
                <Redirect to="/" />
              ) : (
                <CookieContext>
                  <MainContext>
          ...
          <Route
            path="/Logout"
            render={() =>
              hasJWT() === false ? <Redirect to="/" /> : <Logout />
            }
          />
          <Route
            path="/"
